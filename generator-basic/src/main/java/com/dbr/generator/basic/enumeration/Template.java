...
public enum Template {
    ...
    ITEM_JAVA_SPRINGBOOT_JPA_SERVICE_SEARCH_TEMPLATE("item/java/springboot/jpa-service-search.vm", "", "", LanguageType.JAVA),
    ...
    ITEM_TYPESCRIPT_MODEL_ENUM_TEMPLATE("item/typescript/model-enum.vm", "model/", "-model", LanguageType.TYPESCRIPT),
    ...
    Template(String templatePath, String filePrefix, String fileSuffix, LanguageType languageType) {
