...
export class ProcessEditPage extends DefaultPage {
  constructor() {
    super();
    this.navigationTitle = I18nService.getUniqueInstance().getValue('process_nav_edit');
  }

  @query('#editComponent')
  editComponent: NidocaAbstractComponentEdit<Process> | undefined;
  ...
  getTopRightComponent(): TemplateResult {
    return html`
      <nidoca-icon
        ...
        icon="${RouterService.getUniqueInstance().getStateProperty('id') != null ? 'arrow_back' : 'cancel'}"
        clickable="true"
      ...
      <nidoca-icon
        ...
        .rendered="${RouterService.getUniqueInstance().getStateProperty('id') != null}"
        slot="rightComponents"
        icon="delete"
        clickable="true"
    ...
    return html`
      ...
      >
        ...
        >
          ...
          <process-edit-component id="editComponent"></process-edit-component> </nidoca-flex-container
      ></nidoca-grid-container>
    `;
  }
