...
import {LanguageTypeRemoteRepository} from '../repo/languagetype-repository';

@customElement('languagetype-combobox-component')
export class LanguageTypeCombobox extends NidocaInputfield {
   ...
   protected update(changedProperties: Map<PropertyKey, unknown>): void {
        ...
        if (
            ...
            LanguageTypeRemoteRepository.getUniqueInstance()
            .getAll()
            .then((value) => {
                this.options = value;
