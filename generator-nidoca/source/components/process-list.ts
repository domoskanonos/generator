import {NidocaAbstractComponentSearchList} from '@domoskanonos/nidoca-app';
...
export class ProcessSearchNidocaList extends NidocaAbstractComponentSearchList<Process> {
  ...
  renderListItem(process: Process): TemplateResult {
    return html`
      ...
      <nidoca-spacer .spacerSize="${SpacerSize.MAX}" spacerAlignment="${SpacerAlignment.HORIZONTAL}">
        ...
        >
          <nidoca-typography
            ...
            text="${process.technicalDescriptor}"
          ></nidoca-typography>
          <nidoca-typography
            .typographyType="${TypographyType.BODY1}"
            text="${process.processParentPath}"
          ></nidoca-typography>
        </nidoca-flex-container>
      </nidoca-spacer>
      <nidoca-spacer .spacerSize="${SpacerSize.MEDIUM}" spacerAlignment="${SpacerAlignment.VERTICAL}"></nidoca-spacer>
  ...
  renderNoRecord(): TemplateResult {
    return html`
      <nidoca-flex-container
        ...
        .alignItems="${FlexAlignItems.CENTER}"
      >
        <nidoca-spacer .spacerSize="${SpacerSize.BIG}" spacerAlignment="${SpacerAlignment.BOTH}">
          <nidoca-typography
