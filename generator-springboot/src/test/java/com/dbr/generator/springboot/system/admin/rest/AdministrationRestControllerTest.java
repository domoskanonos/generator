...
public class AdministrationRestControllerTest {
    ...
    public void pdfApplicationProperties() {
        ResponseEntity<InputStreamResource> responseEntity = restTemplate.getForEntity(
                String.format("/%s/PDF/APPLICATION_PROPERTIES", AdministrationRestController.PATH_PREFIX),
    ...
    public void changeRootLogLevel() {
        ...
        UriComponentsBuilder builder = UriComponentsBuilder
                .fromHttpUrl(
                        restTemplate.getRootUri() + AdministrationRestController.PATH_PREFIX + "/LOG_CHANGE/GLOBAL")
                .queryParam("loglevel", newLogLevel.name());

        HttpEntity<HttpStatus> response = restTemplate.exchange(builder.build().encode().toUri(), HttpMethod.POST, null,
                HttpStatus.class);
    ...
    public void changeLogLevel() {
        ...
        UriComponentsBuilder builder = UriComponentsBuilder
                .fromHttpUrl(
                        restTemplate.getRootUri() + AdministrationRestController.PATH_PREFIX + "/LOG_CHANGE/BY_PACKAGE")
