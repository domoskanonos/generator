...
public class ESRepositoryVM {
    ...
    public ESRepositoryVM(String repositoryClazzPackageName, String repositoryClazzSimpleName, Class<?> clazz) {
        this(repositoryClazzPackageName, repositoryClazzSimpleName, clazz.getPackage().getName(), clazz.getSimpleName(), GeneratorUtil.getIDClazzSimpleName(clazz), new ArrayList<>());
