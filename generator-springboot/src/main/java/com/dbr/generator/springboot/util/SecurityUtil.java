...
public class SecurityUtil {
    ...
    public static void main(String[] args) {
        String encrypt = SecurityUtil.getUniqueInstance().encrypt("generator-springboot-mail");
        LOGGER.log(Level.INFO, encrypt);
        String decrypt = SecurityUtil.getUniqueInstance().decrypt(encrypt);
        LOGGER.log(Level.INFO, decrypt);
        encrypt = SecurityUtil.getUniqueInstance().encrypt("generator-springboot-mail-123");
        LOGGER.log(Level.INFO, encrypt);
        decrypt = SecurityUtil.getUniqueInstance().decrypt(encrypt);
        LOGGER.log(Level.INFO, decrypt);
    }
