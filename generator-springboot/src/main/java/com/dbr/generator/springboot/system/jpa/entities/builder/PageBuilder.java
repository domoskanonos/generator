package com.dbr.generator.springboot.system.jpa.entities.builder;
...
public abstract class PageBuilder<T, S> {
    ...
    protected abstract void createPredicates(CriteriaBuilder cq, CriteriaQuery<T> productCriteriaQuery,
            Root<T> entityRoot);
