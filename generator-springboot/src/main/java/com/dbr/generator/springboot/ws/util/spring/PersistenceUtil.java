...
public class PersistenceUtil {
    ...
    public Pageable preparePageable(CriteriaBuilder cb, CriteriaQuery<?> cq, Root<?> entityRoot, TypedQuery<?> query, Integer page, Integer size, String sort, int totalRows) {
