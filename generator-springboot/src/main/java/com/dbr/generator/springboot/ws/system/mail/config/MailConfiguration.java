package com.dbr.generator.springboot.ws.system.mail.config;

import com.dbr.generator.springboot.ws.system.ApplicationProperties;
import com.dbr.generator.springboot.ws.system.enumeration.BuildEnvironment;
...
public class MailConfiguration {
    ...
    public JavaMailSender javaMailService() {
        ...
        try {
            ...
            if (!this.applicationProperties.getBuildEnvironments().contains(BuildEnvironment.DEV) && StringUtils.isNotBlank(propertyUsername) && StringUtils.isNotBlank(propertyPassword)) {
            ...
            log.warn("error decrypting email username or password for mail configuration, do you set the correct secret key for decrypting ?");
        } catch (NegativeArraySizeException e) {
            log.warn("error decrypting email username or password for mail configuration, do you set the correct encrypted spring property pring.mail.username or spring.mail.password ?");
        }
        ...
        setMailProperty(props, "mail.smtp.starttls.enable", this.environment.getProperty("spring.mail.properties.mail.smtp.starttls.enable"));
