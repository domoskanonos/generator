...
public class RegistrationConfirmMailMergerInterface implements FreemarkerMergerInterface<RegistrationConfirmModel> {

    @Override
    public String create(RegistrationConfirmModel model) throws IOException, TemplateException {
        ...
        Template temp = configuration.getTemplate(new StringBuilder().append("/mail/community/").append(model.getLocale().getLanguage()).append("-registration-confirm.ftlh").toString());
        Map<String, RegistrationConfirmModel> root = new HashMap<>();
