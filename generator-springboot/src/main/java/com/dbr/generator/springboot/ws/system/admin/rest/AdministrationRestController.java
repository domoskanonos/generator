...
import com.dbr.generator.springboot.ws.pdf.impl.ApplicationPropertiesPDFCreator;
...
public class AdministrationRestController {
    ...
    public ResponseEntity<InputStreamResource> downloadApplicationProperties() {
        PDFModel pdfModel = new ApplicationPropertiesPDFCreator(env).get();
        return ResponseEntity.ok()
                .contentLength(pdfModel.getLength())
                .headers(pdfModel.getHeaders())
                .contentType(MediaType.parseMediaType(MediaType.APPLICATION_OCTET_STREAM_VALUE))
                .body(new InputStreamResource(pdfModel.get()));
    }
    ...
    public ResponseEntity changeLogLevelByPackageName(@RequestParam("loglevel") String logLevel, @RequestParam(value = "packageName") String packageName) {
