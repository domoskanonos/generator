...
public class AuthUser {
    ...
    @JoinTable(name = "USERS_ROLES", joinColumns = @JoinColumn(name = "USER_ID", nullable = false, updatable = false, referencedColumnName = "ID"), inverseJoinColumns = @JoinColumn(name = "ROLE_ID", nullable = false, updatable = false, referencedColumnName = "ID"))
